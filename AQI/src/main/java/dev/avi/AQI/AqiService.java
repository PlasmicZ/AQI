...
//        aqiData.setCity(records.toString());
        aqiData.setCity(records.getString("city"));
        aqiData.setState(records.getString("state"));
        aqiData.setLastUpdate(records.getString("last_update"));
        aqiData.setPollutantAvg(records.getString("pollutant_avg"));
        aqiData.setPollutantMin(records.getString("pollutant_min"));
        aqiData.setPollutantMax(records.getString("pollutant_max"));
